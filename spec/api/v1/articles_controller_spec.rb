...
RSpec.describe "Notebooks", type: :system do
    ...
    it "creates a new account" do
        ...
        fill_in "Username", with: "oussema"
        sleep(1)
        fill_in "First Name", with: "oussema"
        sleep(1)
        fill_in "Last Name", with: "oussema"
        sleep(1)
        fill_in "Email", with: "oussema@gmail.com"
        sleep(1)
    ...
    it "Delete the article" do
      ...
      it "updates the article" do
        ...
        fill_in "Title", with: "Wanderlust Words"
        sleep(1)
        fill_in "Body", with: " c'est un nouveau article c'est un nouveau articlec'est un nouveau article c'est un nouveau article  "
        sleep(1)
        select "public", from: "Status"
        sleep(1)
        click_button "Create Article"
      ...
      it "Create new comment " do
        ...
        fill_in "Body", with: " Unearth the mysteries"
        sleep(1)
        select "public", from: "Status"
        sleep(1)
